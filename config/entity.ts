  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'e.g., My SaaS Idea — Task Management for Freelancers',
      showInList: true,
      showInForm: true,
    },
    {
      ...
      type: 'rich-text',
      required: true,
      placeholder: 'Describe your SaaS idea in detail. What problem does it solve? Who is it for? How does it work?',
      showInList: true,
      showInForm: true,
    },
    {
      ...
      type: 'multi-select',
      required: true,
      options: ['Indie Hackers', 'Solo Founders', 'Early-Stage Startup Founders', 'Product Managers', 'Entrepreneurs', 'Small Business Owners'],
      showInList: true,
      showInForm: true,
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['Idea Submitted', 'Channels Discovered', 'Collecting Responses', 'Analysis Complete'],
      defaultValue: 'Idea Submitted',
      showInList: true,
      showInForm: true,
    },
    {
      name: 'channels_identified',
      label: 'Identified Channels',
      type: 'rich-text',
      required: false,
      placeholder: 'AI-discovered channels will appear here after Step 2...',
      showInList: false,
      showInForm: true,
    },
    {
      name: 'research_responses',
      label: 'Research Responses',
      type: 'rich-text',
      required: false,
      placeholder: 'Paste your raw conversation responses from Reddit, Discord, X, etc. here...',
      showInList: false,
      showInForm: true,
    },
    {
      ...
      type: 'text',
      required: false,
      placeholder: 'AI-generated verdict will appear after analysis...',
      showInList: false,
      showInForm: true,
    },
    {
    ...
    },
    {
      ...
      type: 'number',
      required: false,
      placeholder: 'Number of responses collected',
      showInList: false,
      showInForm: true,
    },
    {
      ...
      type: 'url',
      required: false,
      placeholder: 'https://convoflow.vercel.app/reports/...',
      showInList: false,
      showInForm: true,
    }
  ],
